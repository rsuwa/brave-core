...
std::optional<PolkadotChainMetadata> PolkadotChainMetadata::FromBytes(
  ...
  return FromFields(parsed->system_pallet_index(),
                    ...
                    parsed->assets_transfer_all_call_index(),
...
uint8_t PolkadotChainMetadata::GetAssetsTransferAllCallIndex() const {
  return chain_metadata_.assets_transfer_all_call_index;
}
